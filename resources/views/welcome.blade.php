...
<head>
   ...
   <link rel="stylesheet" href="{{asset('css/welcome/owl.carousel.min.css')}}">
   <!-- fevicon -->
   <link rel="icon" href="{{asset('images/fevicon.png')}}" type="image/gif" />
   <!-- Scrollbar Custom CSS -->
   <link rel="stylesheet" href="{{asset('css/welcome/jquery.mCustomScrollbar.min.css')}}">
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-5 d_none">
                     <ul class="sign">
                        <li><a class="sign_btn" href="{{ route('login') }}">To Shortlisting</a></li>
                     </ul>
                  </div>
               </div>
            </div>
